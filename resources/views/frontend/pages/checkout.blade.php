                                    ...
                                    <div class="content">
                                        <ul>
                                                ...
                                                @if(count(Helper::shipping()) > 0 && Helper::cartCount() > 0)
                                                    <select name="shipping" class="nice-select">
                                                        @foreach(Helper::shipping() as $index => $shipping)
                                                            <option value="{{$shipping->id}}" class="shippingOption" data-price="{{$shipping->price}}" {{ $index == 0 ? 'selected' : '' }}>
                                                             
                                                                    <span style="margin-right: 50px;">{{ $shipping->type }}</span>: £{{ $shipping->price }}
                                                                </p>
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            @php
                                                ...
                                                $shipping_cost = count(Helper::shipping()) > 0 ? Helper::shipping()[0]->price : 0;
...
@push('scripts')
	...
	<script>
		$(document).ready(function() { 
            ...
            // Calculate initial total with first shipping option
            updateOrderTotal();
        ...
        function updateOrderTotal() {
            ...
            // Calculate total including shipping and coupon
